...
import Logo from "../assets/LogoHugo.png";
      ...
      <nav
        className={
          darkMode
            ...
            : "bg-gray-100 border-white z-50 shadow-lg md:px-8 px-1 fixed w-full top-0"
        }
      >
        <div className="flex justify-between items-center py-2 md:py-4 md:px-2 pl-2 mx-auto">
          <div className="flex items-center cursor-pointer">
            <a
              ...
              className={
                darkMode
                  ? "text-3xl font-bold text-decoration-none whitespace-nowrap text-blackround"
                  : "text-3xl font-bold text-decoration-none whitespace-nowrap text-yellow-500"
              }
            >
            ...
            >
              {links.map((el, index) => (
                <li key={index} className="cursor-pointer">
                  <Link
                    to={el.route}
                    activeClass={darkMode ? "text-white bg-blue-500" : "text-white bg-yellow-500"}
                    spy={true}
                    smooth={true}
                    className={
                      darkMode
                        ? "block py-2 px-3 text-black hover:bg-blue-500 hover:text-white rounded-md "
                        : "block py-2 px-3 text-white-500 hover:bg-yellow-500 hover:text-gray-100 rounded-md"
                    }
                  >
                    {el.name}
                  </Link>
                ...
                <Link
                  ...
                  className={
                    darkMode
                      ...
                      : "hover:bg-yellow-500 text-black block px-3 py-2 rounded-md text-base font-medium mt-1 hover:text-white"
                  }
                  spy={true}
                  smooth={true}
